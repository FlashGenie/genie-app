    ...
    return(
        <div className = "flex w-full">
            <div className="flex-grow p-6 bg-gray-100 min-h-screen-minus-80">
                ...
                <div className="flex flex-nowrap overflow-x-auto -mx-3 overflow-visible" ref={scrollRef}>
                    {recentDecks.map((set) => (
                        <div className="flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 overflow-visible" key={set._id}>
                            <div className="hover:scale-100 p-3 overflow-visible">
                            <FlashcardSet
                                key={set._id}
                                deckId={set._id}
                                title={set.name}
