    ...
    return(
        <>
            <div className="flex flex-col items-center font-sans">
                <h1 className="font-bold w-3/4 text-[5rem] text-center pt-32">AI-Powered Flashcards <img src="../../public/flashcard.svg" className="inline"/> from your notes, made effortless</h1>
